...
<div class="content d-flex flex-column align-items-center">
  ...
  <h4 class="h-title">면접 안내 및 시작하기</h4>
    ...
    <div class="guide-text d-flex flex-column align-items-center" style="text-align: center;">
      ...
      <p><span style="font-weight: bold;">맞춤 질문·답변 생성 (Stage 1~3):</span> 자기소개서를 입력하면 AI를 활용하여 맞춤형 질문과 답변을 준비할 수 있습니다.</p>
      <p><span style="font-weight: bold;">가상 영상 면접 (Stage 4~5):</span> 가상 영상 면접을 통해 면접 경험을 쌓고, 면접 내역을 확인할 수 있습니다.</p>
