                            ...
                            <table class="table table-hover align-middle">
                                ...
                                <c:forEach items="${selfBoards}" var="selfBoard" varStatus="i">
                                    <tr>
                                        ...
                                        <td><a href="${pageContext.request.contextPath}/mypage/mypagelist/${selfBoard.selfIdx}"><c:out value="${selfBoard.selfTitle}"/></a></td>
                                        ...
                                        <td>
                                            <div class="d-flex gap-2">
                                                <button class="btn btn-sm btn-outline-primary" onclick="location.href='${pageContext.request.contextPath}/mypage/mypagelist/${selfBoard.selfIdx}'">수정</button>
                                                <button class="btn btn-sm btn-outline-danger" onclick="if(confirm('정말 삭제하시겠습니까?')) location.href='${pageContext.request.contextPath}/mypage/remove/${selfBoard.selfIdx}'">삭제</button>
                                            </div>
                                        </td>
                                    </tr>
                                </c:forEach>
