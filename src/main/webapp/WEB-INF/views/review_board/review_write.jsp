			...
			<div class="content-section">
				...
				<div id="free-format">
					<div class="content-group">
						...
						<textarea class="content-textarea" name="atmosphere" placeholder=""></textarea>
					</div>
					<div class="content-group">
						<label class="content-label">면접에서 좋았던 점이나 아쉬웠던 점은 무엇입니까?</label>
						<textarea class="content-textarea" name="sorrow" placeholder=""></textarea>
					</div>
					<div class="content-group">
						<label class="content-label">면접 합격 팁이나 조언이 있다면?</label>
						<textarea class="content-textarea" name="advice" placeholder=""></textarea>
					</div>
				</div>
				...
				<div id="qa-format" style="display: none;">
					<div id="questions-container">
						<div class="question-section">
							...
							<input type="text" class="input-field mb-3" name="questions[0].question" placeholder="질문을 입력하세요">
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        document.querySelector('.add-question-btn').addEventListener('click', function() {
            ...
            newQuestion.innerHTML = `
                ...
                <input type="text" class="input-field mb-3" name="questions[${questionCounter}].question" placeholder="질문을 입력하세요">
                <textarea class="content-textarea" name="questions[${questionCounter}].answer" placeholder="답변을 입력하세요..."></textarea>
            `;
        ...
        form.addEventListener('submit', function(event) {
            ...
            if (formatType === 'free') {
                const textareas = freeFormat.querySelectorAll('.content-textarea');
                ...
                if (!hasContent) {
                    alert('자유 양식에서 최소 1개 이상의 항목을 작성해주세요.');
                    isValid = false;
                }
            } else {
                const questions = qaFormat.querySelectorAll('.question-section');
                let hasValidQA = false;

                questions.forEach(question => {
                    const questionInput = question.querySelector('input');
                    const answerInput = question.querySelector('textarea');
                ...
                if (!hasValidQA) {
                    alert('질문-답변 형식에서 최소 1개 이상의 질문과 답변을 작성해주세요.');
                    isValid = false;
                }
            }
